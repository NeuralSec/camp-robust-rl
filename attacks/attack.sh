...
do
#Run correspoinding script in {cartpole_simple_attack.py, cartpole_multiframe_attack.py, pong_1r_attack.py, freeway_attack.py, highway_attack.py, bankheist_attack.py}
